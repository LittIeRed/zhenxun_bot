    ...
    if check > succes1:
        ...
        if check < random.randint(succes * 27 // 100, succes * 36 // 100):
            ...
            if xgold2 > cost * 3:
                ...
                print("ban_tiem", ban_tiem)
                if not is_number(ban_tiem):
                    ban_tiem = 0.5
                    print("ban_tiem is not number", ban_tiem)
                if int(ban_tiem) <= 0:
                    ban_tiem = 0.5
                    print("ban_tiem <= 0", ban_tiem)
                await BanUser.ban(uid, 4, ban_tiem * 3600)
                print("ban_tiem输出字符串", ban_tiem)
